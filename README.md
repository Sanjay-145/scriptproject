...
.banner{
    display: block;
    width: 100%;
    background-color: rgb(179, 0, 164);
    padding-top: 20px;
    text-align: center;
    height: 60px;
}
...
## OUTPUT:
![output](./static/img/a.png)
![output](./static/img/b.png)
...
## RESULT:
Thus a website is designed for calculating the sum of two numbers and volume of a cylinder is hosted in the URL http://sanjay.student.saveetha.in:8000/mathadd/ and http://sanjay.student.saveetha.in:8000/cylindervolume/ . HTML code is validated.